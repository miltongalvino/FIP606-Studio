...
custom_css <- "
  ...
  .summary-chip { background: #F1F3F4; border: 1px solid #E8EAED; border-radius: 20px; padding: 6px 16px; font-size: 0.82rem; font-weight: 600; color: #3C4043; display: flex; align-items: center; gap: 6px; }
  .summary-chip .chip-icon { color: #1A73E8; }
  .summary-chip.chip-ok { background: #E6F4EA; border-color: #CEEAD6; color: #137333; }
  .summary-chip.chip-warn { background: #FEF7E0; border-color: #FDD663; color: #7A4F00; }
"
